...
pub struct StreamBlocksRequestFilter {
    #[prost(uint64, tag = "1")]
    pub from: u64,
    #[prost(uint64, tag = "2")]
    pub to: u64,
...
pub mod btc_server_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn stream_blocks(
            &mut self,
            request: impl tonic::IntoRequest<super::StreamBlocksRequestFilter>,
        ) -> std::result::Result<
            tonic::Response<super::StreamBlocksResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/fuel_streamer.BtcServer/StreamBlocks",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("fuel_streamer.BtcServer", "StreamBlocks"));
