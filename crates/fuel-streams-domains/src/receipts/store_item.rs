...
impl DataEncoder for ReceiptStoreItem {
    type Err = DbError;
}

impl StoreItem for ReceiptStoreItem {
...
impl PartialOrd for ReceiptStoreItem {
    fn partial_cmp(&self, other: &Self) -> Option<Ordering> {
        Some(self.cmp(other))
    }
}

impl Ord for ReceiptStoreItem {
