        ...
        try_packet_subject_match!(packet, {
            ReceiptsCallSubject => subject => {
                Ok(ReceiptDbItem {
                    ...
                    from_contract_id: Some(subject.from_contract_id.unwrap().to_string()),
                    to_contract_id: Some(subject.to_contract_id.unwrap().to_string()),
            ...
            ReceiptsMessageOutSubject => subject => {
                Ok(ReceiptDbItem {
                    ...
                    contract_id: None,
                    sub_id: None,
                    sender_address: Some(subject.sender_address.unwrap().to_string()),
                    recipient_address: Some(subject.recipient_address.unwrap().to_string()),
                })
            },
